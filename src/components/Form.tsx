  ...
  return (
    <>
      ...
      >
        ...
        >
          <label className="flex flex-col gap-1 text-sm sm:text-base font-medium text-[var(--primary)]">
            Nombre completo
            <input
              name="name"
              type="text"
              placeholder="Ej. Ana López"
              className="w-full p-3 border border-[var(--outlineVariant)] rounded focus:ring-2 focus:ring-[var(--primary)] transition-all text-base bg-[var(--primaryContainer)] dark:bg-[var(--primaryContainer)]/30 placeholder:text-[var(--outline)]"
              required
              value={name}
          ...
          <label className="flex flex-col gap-1 text-sm sm:text-base font-medium text-[var(--primary)]">
            ...
            <input
              name="specialty"
              type="text"
              placeholder="Ej. Psicología, Nutrición, etc."
              className="w-full p-3 border border-[var(--outlineVariant)] rounded focus:ring-2 focus:ring-[var(--primary)] transition-all text-base bg-[var(--primaryContainer)] dark:bg-[var(--primaryContainer)]/30 placeholder:text-[var(--outline)]"
              required
              value={speciality}
          ...
          <label className="flex flex-col gap-1 text-sm sm:text-base font-medium text-[var(--primary)]">
            ...
            <input
              name="location"
              type="text"
              placeholder="Ej. CDMX, Jalisco, etc."
              className="w-full p-3 border border-[var(--outlineVariant)] rounded focus:ring-2 focus:ring-[var(--primary)] transition-all text-base bg-[var(--primaryContainer)] dark:bg-[var(--primaryContainer)]/30 placeholder:text-[var(--outline)]"
              required
              value={location}
